...
--
-- Host: localhost    Database: yssworkshpo
-- ------------------------------------------------------
...
INSERT INTO `django_migrations` VALUES (1,'contenttypes','0001_initial','2021-03-19 15:05:56.976858'),(2,'auth','0001_initial','2021-03-19 15:05:57.527233'),(3,'admin','0001_initial','2021-03-19 15:05:59.107563'),(4,'admin','0002_logentry_remove_auto_add','2021-03-19 15:05:59.425947'),(5,'admin','0003_logentry_add_action_flag_choices','2021-03-19 15:05:59.476810'),(6,'contenttypes','0002_remove_content_type_name','2021-03-19 15:05:59.902954'),(7,'auth','0002_alter_permission_name_max_length','2021-03-19 15:06:00.169860'),(8,'auth','0003_alter_user_email_max_length','2021-03-19 15:06:00.268273'),(9,'auth','0004_alter_user_username_opts','2021-03-19 15:06:00.292211'),(10,'auth','0005_alter_user_last_login_null','2021-03-19 15:06:00.511724'),(11,'auth','0006_require_contenttypes_0002','2021-03-19 15:06:00.526441'),(12,'auth','0007_alter_validators_add_error_messages','2021-03-19 15:06:00.557438'),(13,'auth','0008_alter_user_username_max_length','2021-03-19 15:06:01.234332'),(14,'auth','0009_alter_user_last_name_max_length','2021-03-19 15:06:01.909501'),(15,'auth','0010_alter_group_name_max_length','2021-03-19 15:06:02.023704'),(16,'auth','0011_update_proxy_permissions','2021-03-19 15:06:02.062005'),(17,'auth','0012_alter_user_first_name_max_length','2021-03-19 15:06:02.338276'),(18,'sessions','0001_initial','2021-03-19 15:06:02.469561');
...
INSERT INTO `django_session` VALUES ('7ww9kn8bl5f22vzgfngxd78q96s7wska','eyJ1c2VyIjoxfQ:1lNym7:SkLxGEsPb7gfKujWwKZSklAJGN0l8nNl9zvUgnUQCNI','2021-04-04 14:09:51.556875');
...
CREATE TABLE `link` (
  ...
  `date` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  CONSTRAINT `admin_to_link` FOREIGN KEY (`id`) REFERENCES `admin` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `link` VALUES (1,1,'lkjsdlkfs88w0ukjl',0,'2021-03-21 19:37:02');
/*!40000 ALTER TABLE `link` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'yssworkshpo'
--
...
-- Dump completed on 2021-03-21 21:16:37
